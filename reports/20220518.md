...
- What worked for us
    ...
    - Zoom call
- What we learned
    - That our tests unnecessary get triggered when creating updates to README.md
...
- Angkana Rattanasouk
    ...
    - Where you had trouble
        - Using the Model and ViewModel or how to pass and update isSelected options and 
